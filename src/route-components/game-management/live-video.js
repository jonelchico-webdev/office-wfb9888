...
export default function LiveVideo() {
	...
	const strings = useLanguages(LIVE_VIDEO);
	...
	const { data, loading } = useGameManagementVendorQuery({ gameType: "R2FtZVR5cGVOb2RlOjcxNQ==", rowsPerPage, before, after, mutate, open })
	if (loading) {
		return < Loading / >
	}
	...
	return <Paper elevation={1} className={classes.paper}>
		<Title pageTitle={strings.liveVideo} />
