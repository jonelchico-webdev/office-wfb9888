...
import { MEMBER_NEWS_INBOX, MEMBER_NEWS_SEND_MESSAGE, MEMBER_NEWS_INBOX_VIEW } from '../../../paths';
...
export default function Inbox(props) {
    ...
    const { data, loading } = useMessageQuery({
        ...
        fromUser_Username: filter.filterValues.sender,
    ...
    return <Paper elevation={1} className={classes.paper}>
        <Title pageTitle={strings.memberNewsInbox} />
                            ...
                            return (
                                <Fragment>
                                    <TableRow key={idx} className={o.node.isRead ? classes.tcellRead : classes.tcellUnread}>
                                        ...
                                        <TableCell><Typography className={o.node.isRead ?  classes.grey : classes.bold}>{o.node.id}</Typography></TableCell>
                                        <TableCell><Typography className={o.node.isRead ?  classes.grey : classes.bold}>{o.node.title}</Typography></TableCell>
                                        {/* <TableCell>{o.messageCategory}</TableCell> */}
                                        <TableCell><Typography className={o.node.isRead ?  classes.grey : classes.bold}>{o.node.toUser ? o.node.toUser.username : null}</Typography></TableCell>
                                        <TableCell><Typography className={o.node.isRead ?  classes.grey : classes.bold}>{moment(o.node.createdAt).format("YYYY-MM-DD HH:MM")}</Typography></TableCell>
                                        <TableCell><Typography className={o.node.isRead ?  classes.grey : classes.bold}>{o.node.fromUser ? o.node.fromUser.username : null}</Typography></TableCell>
                                        <TableCell>
                                            <Typography className={o.node.isRead ?  classes.grey : classes.green}>{o.node.isRead ? strings.haveRead : strings.unread} </Typography>
                                        </TableCell>
                                        <TableCell>
                                            <Grid container spacing={1} direction="row" >
                                                ...
                                                <Grid item>
                                                    <Button size="small" onClick={() => deleteMessage(o.node.id, o.node.title)}><Typography className={o.node.isRead ?  classes.grey : classes.bold} >{strings.delete}</Typography></Button>
                                                </Grid>
                                            </Grid>
                                        </TableCell>
                                    </TableRow>
