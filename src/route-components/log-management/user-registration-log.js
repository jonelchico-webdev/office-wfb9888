...
import { USER_REGISTRATION_LOG, USER_MANAGEMENT } from '../../paths';
...
export default function UserLoginLog(props) {
    ...
    const strings = useLanguages(USER_REGISTRATION_LOG);
    ...
    //         const count = firstPaymentVerification.length
            ...
            return <Grid>
                ...
                <Grid container>
                    <Typography variant='h6'>{strings.userRegistrationLog}</Typography>
                </Grid>
                ...
                <SimpleTable
                    ...
                    columns={
                        <TableRow>
                            ...
                            <TableCell align="right" style={{whiteSpace: 'nowrap'}}>{strings.registrationTime}</TableCell>
                            <TableCell align="right" style={{whiteSpace: 'nowrap'}}>{strings.registeredIP}</TableCell>
                        </TableRow>
                    }
                    rows={
						logUsers.length === 0 ? 
						...
						:
                        logUsers.length > 0?
                        logUsers.map((o, index) => {
                            let registrationTimeUTC = moment.utc(o.node.user.registeredAt).format('YYYY-MM-DD HH:mm:ss')
                            let registrationTimeLocal = moment.utc(registrationTimeUTC).local().format('YYYY-MM-DD HH:mm:ss')
                            ...
                            return <TableRow key={index}>
                                ...
                                <TableCell align="right" style={{whiteSpace: 'nowrap'}}>{registrationTimeLocal}</TableCell>
