...
export default function ConsumptionBackwater(props) {
	...
	<Grid container spacing={3}>
		...
		<ButtonGroup fullWidth aria-label="full width outlined button group">
			...
			<Button style={{ backgroundColor: "white", color: "blue", borderColor: "blue", marginRight: '0.1rem' }} onClick={() => {history.push(CONSUMPTION_BACKWATER)}}>{strings.consumptionBackwater}</Button>
