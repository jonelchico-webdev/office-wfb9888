...
import {GrowItem, SimpleTable, Title} from '../../../components';
import useLanguages from '../../../hooks/use-languages';
import { COMMISSION_MANAGEMENT_ADD, COMMISSION_MANAGEMENT } from '../../../paths';
import { Radio, RadioGroup, FormControl, FormLabel, 
    FormControlLabel, FormGroup,Input, ButtonGroup, Paper, 
    TableCell, TableRow, Grid, Button, Typography, Divider, 
...
import { ADD_COMMISSION, ADD_COMMISSION_RULE, ADD_COMMISSION_RULE_VENDOR_RATIO } from '../../../queries-graphql/commission-system/mutation/commission-add-mutation'
...
export default function CommissionAdd(props) {
    ...
    async function addCommission(event) {
        ...
        const res = await commission({
            variables: {
                ...
                minHasBetDescendantCount: parseInt(values.effectiveBet),
                minHasDepositedDescendantCount: parseInt(values.effectiveRecharge),
    ...
    async function addCommissionRule() {
        ...
        history.push(COMMISSION_MANAGEMENT)
    }

    return <Grid>
            <Title pageTitle='add commission' />
