...
export default function FirstModal({open, setOpen, agentLine, setButtonDisabled}) {
    ...
    return  <Dialog 
            ...
            >
                                ...
                                <Grid container style={{ maxWidth: 300 }} alignItems="center">
                                    <Grid item>
                                        <FormControlLabel
                                            control={
                                                <Checkbox
                                                    checked={Boolean(agentLine.find((id) => { return id === o.node.id ? true : false }))}
                                                    id={o.node.id}
                ...
                <Grid style={{paddingTop: 30, marginBottom: 30}} direction="column" alignItems="center" container>
                    <Grid item>
                        <Button disabled={checkBoxCount === 0 ? true : false} style={{width: 110, marginRight:20, height: 30}} color="primary" variant="contained" type="submit">{strings.save}</Button>
