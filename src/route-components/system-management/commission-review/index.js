						...
						commissionPayments.map((o, idx) =>  {
							...
							return (
								<TableRow>
									...
									<TableCell>{o.node.commissionName}</TableCell>
									<TableCell>{o.node.rootAffiliateUsername}</TableCell>
									<TableCell align="right">{o.node.amount}</TableCell>
									<TableCell align="right">{o.node.memberBankRecord ? o.node.memberBankRecord.balance : "-"}</TableCell>
									<TableCell>
										{
